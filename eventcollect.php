		...
		<div id="content">
			<div id='topic'>
				<div id="recent">
                    ...
                    $data_nums = mysql_num_rows($collection);
                    if($data_nums == 0){
                ?>
                    <a href="">目前尚無資料</a>
				<?php
                        ...
                        while($collection_content = mysql_fetch_assoc($result)){
                    		$title = $collection_content['title'];
							$links = $collection_content['links'];
                ?>
						<a  href="<?php echo $links;?>"><?php echo $title;?></a><br><br>
                <?php
						}
				?>
				</p>
